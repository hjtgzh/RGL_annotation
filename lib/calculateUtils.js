...
export function calcGridItemWHPx(
  ...
  // TODO: 加上Math.max(0, gridUnits - 1) * marginPx？跟calcGridColWidth对应？
  // calcGridItemWHPx类似于，将种的树拆开成多段两头都没有树的情形，计算长度（被拆开的多段，可以用marginPx去拼接）
  return Math.round(
...
export function calcXY(
  ...
  // TODO: 计算有问题，Math.round((left - containerPadding[0]) / (colWidth + margin[0]))
...
/**
 * Given a height and width in pixel values, calculate grid units. 给定像素值的高度和宽度，计算网格单位。
